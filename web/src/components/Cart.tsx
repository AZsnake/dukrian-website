        ...
        {items.length === 0 ? (
          ...
          <>
              ...
              {items.map((item) => (
                <li key={item.id} className="cart-item">
                  ...
                  <div className="cart-item__info">
                    ...
                    <p className="cart-item__price">RM {item.price.toFixed(2)}</p>
            ...
            <div className="cart-footer">
              ...
              <p className="cart-delivery-note">Delivery fee calculated at checkout.</p>
              <button className="btn btn--primary cart-checkout-btn" onClick={() => setCheckoutOpen(true)}>
                Checkout →
              </button>
            </div>
          </>
